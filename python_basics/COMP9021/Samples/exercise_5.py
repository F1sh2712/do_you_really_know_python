...
def paths(for_seed, density, top, bottom):
    ...
    visited = []
    find_path(grid, 0, top, visited, directions, bottom)

    if visited and (9, bottom + 1) in visited:
        for row in range(10):
            for col in range(10):
...
def find_path(grid, row, col, visited, directions, bottom):
    ...
    if row == 9 and grid[row][col] == bottom:
    ...
    for direction in directions:
        ...
        find_path(grid, next_row, next_col, visited, directions, bottom)
